...
export function CreateContactForm({ companies, defaultCompanyId }: Props) {
    ...
    <form action={action} className="rounded-lg border border-border bg-card p-6 space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-1 sm:col-span-2">
          ...
          <input id="name" name="name" required className={I} placeholder="João Silva" />
        </div>
        <div className="space-y-1">
          <label htmlFor="email" className="text-sm font-medium">E-mail</label>
          <input id="email" name="email" type="email" className={I} placeholder="joao@empresa.com" />
        </div>
        <div className="space-y-1">
        ...
        <div className="space-y-1">
          ...
          <input id="role" name="role" className={I} placeholder="CEO, Gerente..." />
        </div>
        <div className="space-y-1">
          <label htmlFor="companyId" className="text-sm font-medium">Empresa</label>
          <select id="companyId" name="companyId" defaultValue={defaultCompanyId ?? ""} className={I}>
      ...
      <div className="flex justify-end gap-3 pt-2">
        <Link href="/contatos" className="rounded-md border border-border px-4 py-2 text-sm font-medium hover:bg-accent">
          Cancelar
        </Link>
